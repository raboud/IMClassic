...
// notify parent window that item became active (mouse is over)
#define SMIN_ACTIVATED				WM_APP+100
// notify parent window that item became inactive (mouse left)
#define SMIN_DEACTIVATED			WM_APP+101
// notify parent window that item was clicked
#define SMIN_CLICKED				WM_APP+102
