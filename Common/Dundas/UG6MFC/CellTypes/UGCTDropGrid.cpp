...
int CUGCTDropGrid::ShowPopupGridWnd()
{
	...
	if ( OnCellTypeNotify(m_ID,m_btnCol,m_btnRow,UGCT_SHOWDROPGRID,(long)m_pDropGridStruct) == FALSE )
...
int CUGCTDropGrid::OnSelectedGridItem( SelectedGridItem *pSelectedInfo /*= NULL*/ )
{
	...
	// notify the devloper 
	if ( OnCellTypeNotify(m_ID,m_btnCol,m_btnRow,UGCT_SELECTEDITEM,(long)pSelectedInfo ) == FALSE )
