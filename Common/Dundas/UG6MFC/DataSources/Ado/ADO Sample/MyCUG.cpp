...
int MyCug::OnMenuStart(int col,long row,int section)
{
	...
	if ( section == UG_GRID )
	{
		AddMenuItem( 1006, "Refresh Data" );
		AddMenuItem( 1007, "Commit changes" );
		AddMenuItem( 1008, "Cancel changes" );
	}
	else if ( section == UG_SIDEHEADING )
	{
		AddMenuItem( 1001, "Insert Row" );
		AddMenuItem( 1002, "Append Row" );
		AddMenuItem( 1003, "Delete Row" );
	}
