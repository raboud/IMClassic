...
int CConnectDlg::FileBrowse()
{
	...
	{
		CString connStr;
		connStr.Format( "Driver={Microsoft Access Driver (*.mdb)};Dbq=%s;Uid=;Pwd=;", fileDlg.GetPathName());
		SetDlgItemText( IDC_DNS_EDIT, connStr );
	}
