...
void COpenDatabaseDlg::OnOK() 
{
	...
	if ( fileName == "" || sql == "" )
	{
		MessageBox( "Not All required fields are populated, please double check",
					"Entry error" );
...
{
	CFileDialog fileDlg( TRUE, "*.mdb", NULL, OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT, 
				"MS Access Files|*.mdb|All Files|*.*|", this );
