...
// added to CUGRecordset
	...
	void ReportSQLError(RETCODE retcode, LPCSTR func, HSTMT hstmt=SQL_NULL_HSTMT); 
...
// Overrides
	...
	virtual BOOL Open(UINT nOpenType, LPCSTR lpszSQL, DWORD dwOptions);  // RFX support
