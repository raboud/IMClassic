...
{
	return CUGCtrl::QuickSetAlignment( LocateCol( col ), row, align );
}
/////////////////////////////////////////////////////////////////////////////
int	CUGExcel::QuickSetBorder(int col,long row,int border)
{
	return CUGCtrl::QuickSetBorder( LocateCol( col ), row, border );
}
/////////////////////////////////////////////////////////////////////////////
...
void CUGExcel::OnSetup()
{
	...
	cell.SetBackColor( RGB(229,228,232));
...
void CUGExcel::OnGetCell(int col,long row,CUGCell *cell)
{
	...
	do
	{
		...
		{	// change the back color of proper heading cells
			cell->SetBackColor( BlendColors( cell->GetBackColor(), cell->GetHBackColor(), .3 ));
			break;
		}
