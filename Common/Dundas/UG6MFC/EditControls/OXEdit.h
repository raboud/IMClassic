...
class UG_CLASS_DECL COXEdit : public CUGEditBase
{
	DECLARE_DYNAMIC(COXEdit)
// Construction
public:
...
class UG_CLASS_DECL COXNumericEdit : public COXEdit
{
// Construction
public:
	// --- In  :
...
protected:
	DECLARE_DYNAMIC(COXNumericEdit)
...
class UG_CLASS_DECL COXCurrencyEdit : public COXNumericEdit
{
// Construction
public:
	// --- In  :
...
protected:
	DECLARE_DYNAMIC(COXCurrencyEdit)
