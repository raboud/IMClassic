...
int COXEdit::DeleteRange(int& nSelectionStart, int& nSelectionEnd, BOOL)
{
	int nDeleteCount=0;
...
int COXNumericEdit::DeleteRange(int& nSelectionStart, int& nSelectionEnd, BOOL bInsert)
{
	...
	else
	{
		...
		{
			nDeletedCount+=COXEdit::DeleteRange(nSelectionStart,
