...
// ==========================================================================
// 							Class Specification : CCFIMaskedEdit
// ==========================================================================
...
//  
//  You are able to attach a CCFIMaskedEdit to an existing edit control by subclassing the latter. 
...
/////////////////////////////////////////////////////////////////////////////
#ifndef __CFIMaskedEdit_h__
#define __CFIMaskedEdit_h__
...
/////////////////////////////////////////////////////////////////////////////
// CCFIMaskedEdit window

class OX_CLASS_DECL CCFIMaskedEdit : public CEdit
{
	DECLARE_DYNAMIC(CCFIMaskedEdit)
...
public:
	...
	CCFIMaskedEdit(LPCTSTR pszMask=_T("")) ;
	
	// --- In     :
	// --- Out    :
	// --- Returns:
	// --- Effect : Destructor of the object
	virtual ~CCFIMaskedEdit() ;
