 ...
 * the licensee.
 *
 * $Id: ssce.h,v 5.14.11 2000/06/28 17:31:12 wsi Exp wsi $
 */
...
/* Data type used to represent text checked by the engine.
 */
#if !defined(SSCE_CHAR)
	#if defined(SSCE_UNICODE)
		/* NOTE: Define SSCE_CHAR as SSCE_U16 if your compiler declares
		 * wchar_t as anything other than a 16-bit integer.
		 */
		#define SSCE_CHAR wchar_t
	#else
		/* SSCE_CHAR can be defined to just "char" if your application uses
...
extern SSCE_S32 API SSCE_CheckBlockDlgTmplt(HWND parent, SSCE_CHAR FAR *block,
  ...
  const char FAR *spellDlgTmpltName,
  const char FAR *lexDlgTmpltName, const char FAR *optDlgTmpltName,
  const char FAR *newLexDlgTmpltName);
...
extern SSCE_S16 API SSCE_EditLexDlgTmplt(HWND parent, HINSTANCE hInst,
  const char FAR *dlgTmpltName, const char FAR *newLexDlgTmptName);

extern SSCE_S16 API SSCE_GetAutoCorrect(void);

extern void API SSCE_GetHelpFile(char FAR *fileName, SSCE_U16 fileNameSz);

extern SSCE_S16 API SSCE_GetLexId(const char FAR *lexFileName);

extern void API SSCE_GetMainLexFiles(char FAR *fileList,
  SSCE_U16 fileListSz);

extern void API SSCE_GetMainLexPath(char FAR *path, SSCE_U16 pathSz);

extern SSCE_S16 API SSCE_GetMinSuggestDepth(void);

extern void API SSCE_GetRegTreeName(char FAR *regTreeName,
  SSCE_U16 regTreeNameSz);

extern void API SSCE_GetSelUserLexFile(char FAR *fileName,
  SSCE_U16 fileNameSz);
...
extern void API SSCE_GetStringTableName(char FAR *tableName,
  SSCE_U16 tableNameSz);

extern void API SSCE_GetUserLexFiles(char FAR *fileList,
  SSCE_U16 fileListSz);

extern void API SSCE_GetUserLexPath(char FAR *path, SSCE_U16 pathSz);

extern SSCE_S16 API SSCE_OptionsDlg(HWND parent);

extern SSCE_S16 API SSCE_OptionsDlgTmplt(HWND parent, HINSTANCE hInst,
  const char FAR *tmpltName);
...
extern SSCE_S16 API SSCE_SetHelpFile(const char FAR *helpFile);

extern SSCE_S16 API SSCE_SetIniFile(const char FAR *iniFile);

extern SSCE_S16 API SSCE_SetKey(SSCE_U32 key);

extern SSCE_S16 API SSCE_SetMainLexFiles(const char FAR *fileList);

extern SSCE_S16 API SSCE_SetMainLexPath(const char FAR *path);

extern SSCE_S16 API SSCE_SetMinSuggestDepth(SSCE_S16 depth);

extern SSCE_S16 API SSCE_SetRegTreeName(const char FAR *regTreeName);

extern SSCE_S16 API SSCE_SetSelUserLexFile(const char FAR *fileName);

extern SSCE_S16 API SSCE_SetStringTableName(const char FAR *tableName);

extern SSCE_S16 API SSCE_SetUserLexFiles(const char FAR *fileList);

extern SSCE_S16 API SSCE_SetUserLexPath(const char FAR *path);
